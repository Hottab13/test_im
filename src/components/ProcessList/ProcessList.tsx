...
export const ProcessList: React.FC = (props) => {
  const processList = useSelector(
    (state: AppStateType) => state.processList.processList
  );
      ...
      <Row style={{ paddingTop: "22px" }}>
        {processList.map((u) => (
          <div className={classes.pla} key={u.id}>
            ...
            <div style={{ border: "none", height: "1px" }}>
              <hr color="#D6DCE9" />
            </div>
            <Row>
              <Col md={2}>
                <Row>
                  ...
                  >
                    <img
                      ...
                      src={numberOfScenarios}
                    />
                  </Col>
                  <Col>
                    <div className={classes.numberOfScenarios}>
                      {u.employeesInvolvedProcess}
                    </div>
                    <div
              ...
              <Col md={2}>
                <Row align="end" style={{ height: "84px" }}>
                  <Col>
                    <Row>
                      <Col md={1}>
                        <img src={averageActiveTime} />
                      </Col>
                      <Col>
                        <div className={classes.textScripts}>
                          <Moment format={"LT"} unix>
                            {u.averageLeadTime}
                          </Moment>
                        </div>
              ...
              <Col md={2}>
                <Row style={{ height: "84px" }} align="end">
                  <Col>
                    <Row>
                      <Col md={1}>
                        <img src={employeesInvolvedProcess} />
                      </Col>
                      <Col>
                        <div className={classes.textScripts}>
                          {u.numberOfExecutions} сотрудников
                        </div>
                        <div className={classes.miniText}>
